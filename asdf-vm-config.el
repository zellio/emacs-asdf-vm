...
(defcustom asdf-vm-dir (or (getenv "ASDF_DIR") (file-name-parent-directory asdf-vm-process-executable))
...
(defconst asdf-vm-config--valid-file-fields
  ...
  "Filter var for `asdf-vm-config--file' serialization.")
...
(defclass asdf-vm-config--file (asdf-vm-ui--file-backed)
  ((legacy-version-file
   ...
   (use-release-candidates
    ...
    :documentation "")
   (always-keep-downloaded
    :initarg :always-keep-downloaded
    :initform nil
    :type boolean
    :custom boolean
...
(cl-defmethod asdf-vm-ui--decode ((class (subclass asdf-vm-config--file)) text)
  "Decode the CLASS `asdf-vm-config--file' from TEXT."
...
(cl-defmethod asdf-vm-ui--encode
  ...
  "Encode `asdf-vm-config--file' OBJ as string."
