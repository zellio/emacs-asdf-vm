...
(cl-defmethod asdf-vm-ui--decode
  ...
  "Decode CLASS `asdf-vm-tool-versions--file-row' from LINE."
...
(cl-defmethod asdf-vm-ui--encode
  ...
  "Encode `asdf-vm-tool-versions--file-row' OBJ to string."
...
(cl-defmethod asdf-vm-ui--decode
  ...
  "Decode CLASS `asdf-vm-tool-versions--file' from TEXT."
  (let* ((lines (string-lines text))
         (filtered-lines
          (seq-map #'asdf-vm-tool-versions--file-decode-line-filter lines))
         (rows
          (seq-map (apply-partially #'asdf-vm-ui--decode
...
(cl-defmethod asdf-vm-ui--encode ((obj asdf-vm-tool-versions--file))
  "Encode `asdf-vm-tool-versions--file' OBJ to string."
